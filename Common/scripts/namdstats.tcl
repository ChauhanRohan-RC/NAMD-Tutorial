#######################################################################################
### Script to extract and analyze data from .log file 							 	 ##
#######################################################################################

# 1. In the terminal, type "tclsh" (or go to VMD -> Extensions -> TkConsole)
# 2. Load the script using "source namdstats.tcl", which does not do anything besides importing the script
# 3. call function 
#		1. data_avg <log_file> [<first timestep> <last timestep>]
#		2. data_time <data_stream> <log_file> [<first timestep> <last timestep>]
