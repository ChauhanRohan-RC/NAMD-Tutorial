...
#
# Job name
#SBATCH --job-name=dna-test-single-node-multithread
#
# Account
...
#module use --append /scratch/apps/modules
#module load openmpi/4.1.6

### ---------------- MAIN SCRIPT ------------------
## APP path (Multicore Version)
NAMD_HOME=/scratch/home/parbati/NAMD/NAMD_2.14_Linux-x86_64-multicore/

## ======= MAIN COMMAND ========
TOTAL_TASKS=$(($SLURM_JOB_NUM_NODES * $SLURM_NTASKS_PER_NODE))

## -> can use +isomalloc_sync option (after namd2)
$NAMD_HOME/namd2 +p$TOTAL_TASKS $WORK_DIR/test.conf > $WORK_DIR/test.log
